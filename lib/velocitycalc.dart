...
class Velocitycalc extends StatefulWidget {
  const Velocitycalc({Key? key}) : super(key: key);

  @override
  _VelocitycalcState createState() => _VelocitycalcState();
}

class _VelocitycalcState extends State<Velocitycalc> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        appBar: AppBar(
          title: const Text("Velocity", style: TextStyle(fontSize: 25)),
            ...
            Row(
              ...
              children: [
                ...
                Container(
                  ...
                  color: Colors.white,
                  child:
                      const Text('V = d/t', style: TextStyle(fontSize: 18.0)),
                ),
              ],
            ),
            Container(
