...
class Densitycalc extends StatefulWidget {
  const Densitycalc({Key? key}) : super(key: key);

  @override
  _DensitycalcState createState() => _DensitycalcState();
}

class _DensitycalcState extends State<Densitycalc> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        appBar: AppBar(
          title: const Text("Density", style: TextStyle(fontSize: 25)),
            ...
            Row(
              ...
              children: [
                ...
                Container(
                  ...
                  color: Colors.white,
                  child:
                      const Text('ρ = m/V', style: TextStyle(fontSize: 18.0)),
                ),
              ],
            ),
            Container(
