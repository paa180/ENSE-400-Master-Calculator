  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        appBar: AppBar(
          title: const Text("Potential Energy", style: TextStyle(fontSize: 40)),
          ...
          children: <Widget>[
            Row(
              ...
              children: [
                ...
                const Padding(
                    padding: EdgeInsets.all(6.0)), //separating padding
                Container(
                  ...
                  color: Colors.white,
                  child:
                      const Text('PE = mgh', style: TextStyle(fontSize: 20.0)),
                ),
              ],
            ),
            Container(
