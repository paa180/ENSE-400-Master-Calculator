...
class Accelerationcalc extends StatefulWidget {
  const Accelerationcalc({Key? key}) : super(key: key);

  @override
  _AccelerationcalcState createState() => _AccelerationcalcState();
}

class _AccelerationcalcState extends State<Accelerationcalc> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        appBar: AppBar(
          title: const Text("Acceleration", style: TextStyle(fontSize: 40)),
            ...
            Row(
              ...
              children: [
                ...
                Container(
                  ...
                  color: Colors.white,
                  child:
                      const Text('a = ∆v/∆t', style: TextStyle(fontSize: 18.0)),
                ),
              ],
            ),
            Container(
