...
class Voltcalc extends StatefulWidget {
  const Voltcalc({Key? key}) : super(key: key);

  @override
  _VoltcalcState createState() => _VoltcalcState();
}

class _VoltcalcState extends State<Voltcalc> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        appBar: AppBar(
          title: const Text("Voltage", style: TextStyle(fontSize: 40)),
            ...
            Row(
              ...
              children: [
                ...
                Container(
                  ...
                  width: 110,
                  color: Colors.white,
                  child: const Text('V = IR', style: TextStyle(fontSize: 18.0)),
                ),
              ],
            ),
            Container(
