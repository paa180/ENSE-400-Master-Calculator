...
class TrigonometricDegrees extends StatefulWidget {
  const TrigonometricDegrees({Key? key}) : super(key: key);

  @override
  _TrigonometricDegreesState createState() => _TrigonometricDegreesState();
}

class _TrigonometricDegreesState extends State<TrigonometricDegrees> {
