...
class Electricfield extends StatefulWidget {
  const Electricfield({Key? key}) : super(key: key);

  @override
  _ElectricfieldState createState() => _ElectricfieldState();
}
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        appBar: AppBar(
          title: const Text("Electric Field", style: TextStyle(fontSize: 25)),
            ...
            Row(
              ...
              children: [
                ...
                Container(
                  ...
                  color: Colors.white,
                  child:
                      const Text('E = F/q', style: TextStyle(fontSize: 18.0)),
                ),
              ],
            ),
            Container(
