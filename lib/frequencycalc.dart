...
class Frequencycalc extends StatefulWidget {
  const Frequencycalc({Key? key}) : super(key: key);

  @override
  _FrequencycalcState createState() => _FrequencycalcState();
}

class _FrequencycalcState extends State<Frequencycalc> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        appBar: AppBar(
          title: const Text("Frequency", style: TextStyle(fontSize: 25)),
            ...
            Row(
              ...
              children: [
                ...
                Container(
                  ...
                  color: Colors.white,
                  child:
                      const Text('F = 1/T', style: TextStyle(fontSize: 18.0)),
                ),
              ],
            ),
            Container(
