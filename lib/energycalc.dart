...
class _EnergycalcState extends State<Energycalc> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:
            const Text("Definition of terms", style: TextStyle(fontSize: 40)),
        ...
        child: Column(
          children: const <Widget>[
            Text(
              '''
            Def: Kinetic Energy
                 Kinetic Energy is an energy that the object possesses due
                 to its motion. It is defined as the work needed to accelerate
            ...
            Def: Potential Energy
                 ...
                 For example, the heavy ball of a demolition machine is storing
                 energy when it is held at an elevated position. Potential 
                 energy is energy held by an object because of its position 
                 relative to other objects. Its international System of
                 Unit (SI) is Joule (J).
            Def: Thermal Energy
