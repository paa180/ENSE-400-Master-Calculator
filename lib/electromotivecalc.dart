...
class Electromotivecalc extends StatefulWidget {
  const Electromotivecalc({Key? key}) : super(key: key);

  @override
  _ElectromotivecalcState createState() => _ElectromotivecalcState();
}

class _ElectromotivecalcState extends State<Electromotivecalc> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        appBar: AppBar(
          title: const Text("Electromotive", style: TextStyle(fontSize: 25)),
