...
class InverseTrigonometric extends StatefulWidget {
  const InverseTrigonometric({Key? key}) : super(key: key);

  @override
  _InverseTrigonometricState createState() => _InverseTrigonometricState();
}

class _InverseTrigonometricState extends State<InverseTrigonometric> {
  ...
  pressedButton(String btnVal) {
    ...
    setState(() {
      if (btnVal == "CL") {
        ...
        expression = expression.replaceAll('sinh', 'sin'); //sine expression
